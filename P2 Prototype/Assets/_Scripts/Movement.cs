...
public class Movement : MonoBehaviour {
	...
	public NodeScript[] nodes; //The array for storing the nodes, they are assigned through the editor.
	public float angleMargin = 45;
    public float distancemargin = 0.0001f;

    public float speed = 5;
	Vector3 moveDirection = Vector3.right; public Vector3 GetMoveDirection() {return moveDirection;}
